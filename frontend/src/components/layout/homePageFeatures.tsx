...
const Features = () => {
    return (
        <div className="min-h-screen w-full dark:bg-[#080808] flex justify-start flex-col dark:text-white px-6 sm:px-12 lg:px-24 pb-20 border-b border-gray-200 dark:border-white/10">
